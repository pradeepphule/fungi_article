...
min(gene_expression[,"FPKM.Salt_rep1"])
max(gene_expression[,"FPKM.Salt_rep1"])
...
x = gene_expression[,"FPKM.Salt_rep1"]
y = gene_expression[,"FPKM.Salt_rep2"]
...
plotCor2("FPKM.Salt_rep1", "FPKM.NoSalt_rep1", "UHR_1 vs HBR_1", "tomato2")
plotCor2("FPKM.Salt_rep2", "FPKM.NoSalt_rep2", "UHR_2 vs HBR_2", "royalblue2")
